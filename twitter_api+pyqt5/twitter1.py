...
class MyWindowClass(QMainWindow, form_class):
    ...
    def twit(self):
        ...
        self.df2 = pd.DataFrame(columns= ['keyword','date', 'text', 'hashtag', 'retweet_count', 'favourite_count']) #store
        ...
        plt.savefig('C:/software/software2/sent.jpg')
        self.sentiment.setStyleSheet('border-image: url(C:/software/software2/sent.jpg);')
        ...
        plt.axis('off')
        plt.savefig('C:/software/software2/word.jpg')
        self.word.setStyleSheet('border-image: url(C:/software/software2/word.jpg);')
    ...
    def hash_t(self):
        hastag_data = self.df["hashtag"].dropna() #ลบข้อมูลที่ว่างออก
